...
SOURCES=DS_Stack.c DS_List.c MU_Logger.c MU_Arg_Check.c MU_Hazard_Pointers.c DS_Stack_Test.c
OBJECTS=$(notdir $(SOURCES:.c=.o))
TARGET=DS_Stack_Test
DEPS=$(addprefix -I, $(PRESENT_DIRECTORY))
VPATH=./Misc_Utils/ ./Misc_Utils/ ./Data_Structures/ ./Data_Structures/Tests
