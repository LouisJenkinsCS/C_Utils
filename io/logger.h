...
#define C_UTILS_ASSERT(condition, logger, message, ...) !condition ? c_utils_logger_log(logger, C_UTILS_LOG_LEVEL_ASSERTION, NULL, message, C_UTILS_LOGGER_STRINGIFY(condition), \
