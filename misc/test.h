...
#define C_UTILS_FAILED(condition, logger, test) C_UTILS_Logger_log(logger, C_UTILS_ASSERTION, NULL, "Failed: %s", C_UTILS_LOGGER_STRINGIFY(condition), \
	__FILE__, C_UTILS_LOGGER_STRINGIFY(__LINE__), __FUNCTION__, test)
